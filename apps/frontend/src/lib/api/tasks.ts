...
import type { Emotion, InferredEmotion } from './emotions';
...
export async function getTasks(
	...
	if (params?.priority_max !== undefined)
		searchParams.set('priority_max', String(params.priority_max));
	if (params?.start_date_from)
		searchParams.set('start_date_from', params.start_date_from);
	if (params?.start_date_to)
		searchParams.set('start_date_to', params.start_date_to);
...
export async function getLastTaskEndTime(): Promise<{
