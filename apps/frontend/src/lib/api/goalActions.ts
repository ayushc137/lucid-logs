 ...
 */
export async function getGoalActions(goalId: string): Promise<ActionListResponse> {
...
export async function createGoalAction(
    ...
    return unwrap(api.post(`goals/${encodeURIComponent(goalId)}/actions`, { json: data }));
}
...
export async function updateGoalAction(
    ...
    return unwrap(
        api.put(`goals/${encodeURIComponent(goalId)}/actions/${encodeURIComponent(actionId)}`, {
            json: data,
        })
    );
}
 ...
 */
export async function deleteGoalAction(goalId: string, actionId: string): Promise<void> {
    await api.delete(
...
export async function reorderGoalActions(
    ...
    await api.put(`goals/${encodeURIComponent(goalId)}/actions/reorder`, { json: data });
}
