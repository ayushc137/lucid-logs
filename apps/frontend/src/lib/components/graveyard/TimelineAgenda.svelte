<!--
  ...
  This component has been deprecated in favor of using only the TimelineGantt view.
  The agenda view was removed to simplify the UI and reduce clutter.

  If you need to restore this component, update the imports to point to the
  correct locations in $lib/components/timeline/ folder.
-->
<script lang="ts">
import {
	Calendar,
...
import CategoryFilter from '$lib/components/timeline/CategoryFilter.svelte';
// Shared components
import DateNavigator from '$lib/components/timeline/DateNavigator.svelte';
import GoalLane from '$lib/components/timeline/GoalLane.svelte';
