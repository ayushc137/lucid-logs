 ...
 */
export function stripHtml(html: string | null | undefined, options?: {
  ...
  text = text.replace(/<li[^>]*data-checked="true"[^>]*>([^<]*)<\/li>/gi, '✓ $1\n');
  text = text.replace(/<li[^>]*data-checked="false"[^>]*>([^<]*)<\/li>/gi, '○ $1\n');
